...
\begin{tabular}{clc}\toprule\textbf{Lines}&\textbf{}&\ensuremath{\FN{\omega}}\\ \midrule\ensuremath{\Numeral{100}\cdots\Numeral{154}}&\emph{First choral ode}&\ensuremath{\Numeral{0.83}}\\\ensuremath{\Numeral{332}\cdots\Numeral{375}}&\emph{Second choral ode}&\ensuremath{\Numeral{0.58}}\\\ensuremath{\Numeral{583}\cdots\Numeral{625}}&\emph{Third choral ode}&\ensuremath{\Numeral{0.71}}\\\ensuremath{\Numeral{781}\cdots\Numeral{800}}&\emph{Fourth choral ode}&\ensuremath{\Numeral{0.67}}\\\ensuremath{\Numeral{944}\cdots\Numeral{987}}&\emph{Fifth choral ode}&\ensuremath{\Numeral{0.47}}\\\ensuremath{\Numeral{1116}\cdots\Numeral{1152}}&\emph{Sixth choral ode}&\ensuremath{\Numeral{0.64}}\\\midrule\multicolumn{3}{r}{\ensuremath{\FN{cumulative}\;\FN{\omega}} = \ensuremath{\Numeral{0.66}}}\\\bottomrule\end{tabular}
}
  \vspace{6pt}
  \subtable[Laments]{
\begin{tabular}{clc}\toprule\textbf{Lines}&\textbf{}&\ensuremath{\FN{\omega}}\\ \midrule\ensuremath{\Numeral{806}\cdots\Numeral{816}}&\emph{Antigone's Lament}&\ensuremath{\Numeral{1.37}}\\\ensuremath{\Numeral{823}\cdots\Numeral{833}}&\emph{Antigone's Lament (cntd.)}&\ensuremath{\Numeral{0.78}}\\\ensuremath{\Numeral{839}\cdots\Numeral{882}}&\emph{Antigone's Lament (cntd.)}&\ensuremath{\Numeral{0.63}}\\\ensuremath{\Numeral{1261}\cdots\Numeral{1269}}&\emph{Kreon's Lament}&\ensuremath{\Numeral{0.38}}\\\ensuremath{\Numeral{1283}\cdots\Numeral{1292}}&\emph{Kreon's Lament (cntd.)}&\ensuremath{\Numeral{1.34}}\\\ensuremath{\Numeral{1306}\cdots\Numeral{1311}}&\emph{Kreon's Lament (cntd.)}&\ensuremath{\Numeral{0.37}}\\\ensuremath{\Numeral{1317}\cdots\Numeral{1325}}&\emph{Kreon's Lament (cntd.)}&\ensuremath{\Numeral{1.13}}\\\ensuremath{\Numeral{1239}\cdots\Numeral{1246}}&\emph{Kreon's Lament (cntd.)}&\ensuremath{\Numeral{0.60}}\\\midrule\multicolumn{3}{r}{\ensuremath{\FN{cumulative}\;\FN{\omega}} = \ensuremath{\Numeral{0.78}}}\\\bottomrule\end{tabular}
}
  \caption{Lyrics}
  \label{tab:lyrics}
\end{table}
...
\begin{tabular}{clc}\toprule\textbf{Lines}&\textbf{}&\ensuremath{\FN{\omega}}\\ \midrule\ensuremath{\Numeral{162}\cdots\Numeral{210}}&\emph{\emph{Kreon:} ἄνδρες, τὰ μὲν δὴ...}&\ensuremath{\Numeral{0.40}}\\\ensuremath{\Numeral{249}\cdots\Numeral{277}}&\emph{\emph{Guard:} οὐκ οἶδ'· ἐκεῖ γὰρ οὔτε...}&\ensuremath{\Numeral{0.57}}\\\ensuremath{\Numeral{280}\cdots\Numeral{314}}&\emph{\emph{Kreon:} παῦσαι, πρὶν ὀργῆς...}&\ensuremath{\Numeral{0.45}}\\\ensuremath{\Numeral{407}\cdots\Numeral{440}}&\emph{\emph{Guard:} τοιοῦτον ἦν τὸ πρᾶγμ'...}&\ensuremath{\Numeral{0.56}}\\\ensuremath{\Numeral{450}\cdots\Numeral{470}}&\emph{\emph{Antigone:} οὐ γάρ τί μοι Ζεὺς...}&\ensuremath{\Numeral{0.56}}\\\ensuremath{\Numeral{473}\cdots\Numeral{495}}&\emph{\emph{Kreon:} ἀλλ' ἴσθι τοι...}&\ensuremath{\Numeral{0.45}}\\\ensuremath{\Numeral{639}\cdots\Numeral{680}}&\emph{\emph{Kreon:} οὕτω γὰρ, ὦ παῖ...}&\ensuremath{\Numeral{0.55}}\\\ensuremath{\Numeral{683}\cdots\Numeral{723}}&\emph{\emph{Haimon:} πἀτερ, θεοὶ φύουσιν...}&\ensuremath{\Numeral{0.45}}\\\ensuremath{\Numeral{891}\cdots\Numeral{928}}&\emph{\emph{Antigone:} ὦ τύμβος, ὦ νυμφεῖον...}&\ensuremath{\Numeral{0.48}}\\\ensuremath{\Numeral{998}\cdots\Numeral{1032}}&\emph{\emph{Teiresias:} γνώσῃ, τέχνης σημεῖα...}&\ensuremath{\Numeral{0.57}}\\\ensuremath{\Numeral{1033}\cdots\Numeral{1047}}&\emph{\emph{Kreon:} ὦ πρέσβυ, πάντες...}&\ensuremath{\Numeral{0.24}}\\\ensuremath{\Numeral{1064}\cdots\Numeral{1090}}&\emph{\emph{Teiresias:} ἀλλ' εὖ γέ τοι...}&\ensuremath{\Numeral{0.82}}\\\ensuremath{\Numeral{1155}\cdots\Numeral{1172}}&\emph{\emph{Messenger:} Κάδμου πάροικοι καὶ...}&\ensuremath{\Numeral{0.51}}\\\ensuremath{\Numeral{1192}\cdots\Numeral{1243}}&\emph{\emph{Messenger:} ἐγώ, φίλη δέσποινα...}&\ensuremath{\Numeral{0.40}}\\\midrule\multicolumn{3}{r}{\ensuremath{\FN{cumulative}\;\FN{\omega}} = \ensuremath{\Numeral{0.50}}}\\\bottomrule\end{tabular}
}
  \vspace{6pt}
  \subfigure[Stichomythia]{
\begin{tabular}{clc}\toprule\textbf{Lines}&\textbf{}&\ensuremath{\FN{\omega}}\\ \midrule\ensuremath{\Numeral{536}\cdots\Numeral{576}}&\emph{Ismene, Antigone and Kreon}&\ensuremath{\Numeral{0.29}}\\\ensuremath{\Numeral{728}\cdots\Numeral{757}}&\emph{Haimon and Kreon}&\ensuremath{\Numeral{0.38}}\\\ensuremath{\Numeral{991}\cdots\Numeral{997}}&\emph{Kreon and Teiresias}&\ensuremath{\Numeral{0.70}}\\\ensuremath{\Numeral{1047}\cdots\Numeral{1063}}&\emph{Kreon and Teiresias}&\ensuremath{\Numeral{0.12}}\\\ensuremath{\Numeral{1172}\cdots\Numeral{1179}}&\emph{Chorus and Messenger}&\ensuremath{\Numeral{0.29}}\\\midrule\multicolumn{3}{r}{\ensuremath{\FN{cumulative}\;\FN{\omega}} = \ensuremath{\Numeral{0.32}}}\\\bottomrule\end{tabular}
}
...
conform tightly to the cumulative \ensuremath{\FN{\omega}} of their category, there is a fair
degree of variation among the laments. Likewise, the anapaests vary so wildly in
their \ensuremath{\FN{\omega}}s that it may be difficult to say very much about them that is
...
\>[3]{}\FN{traditional}{}\<[18]%
\>[18]{}\mathrel{=}{}\<[18E]%
\>[21]{}(\VarSym{*})\;\mathop{\langle\$\rangle}\;[\mskip1.5mu \Numeral{1},\Numeral{2},\Numeral{3}\mskip1.5mu]\circledast [\mskip1.5mu \Numeral{5},\Numeral{6},\Numeral{7}\mskip1.5mu]{}\<[E]%
\\
\>[3]{}\FN{idiomBrackets}{}\<[18]%
\>[18]{}\mathrel{=}{}\<[18E]%
\>[21]{}\llbracket\;[\mskip1.5mu \Numeral{1},\Numeral{2},\Numeral{3}\mskip1.5mu]\;\VarSym{*}\;[\mskip1.5mu \Numeral{5},\Numeral{6},\Numeral{7}\mskip1.5mu]\;\rrbracket{}\<[E]%
\ColumnHook
...
\ColumnHook
\end{hscode}\resethooks
\subsection{Computing \ensuremath{\FN{\omega}}}
\label{sec:computing-omega}

We introduce a data type \ensuremath{\FN{\Omega}} of integer-to-integer ratios which may be
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\mathkw{data}\;\FN{\Omega}\mathrel{=}\FN{\Omega}\;\mathbb{Z}\;\mathbb{Z}{}\<[E]%
\\
\>[3]{}\FN{compute_\omega}\ConSym{::}\FN{\Omega}\to \mathbb{Q}{}\<[E]%
\\
\>[3]{}\FN{compute_\omega}\;(\FN{\Omega}\;\Varid{vs}\;\Varid{es})\mathrel{=}\dfrac{\Varid{vs}}{\Varid{es}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Furthermore, \ensuremath{\FN{\Omega}}s generate a monoid, which is an algebraic structure that
abstracts out the notion of an identity and an associative binary operation that
respects that identity. In this way, we can combine \ensuremath{\FN{\Omega}} values:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\mathkw{instance}\;\mathsf{Monoid}\;\FN{\Omega}\;\mathkw{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mathcal{E}\mathrel{=}\FN{\Omega}\;\Numeral{0}\;\Numeral{0}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}(\FN{\Omega}\;\Varid{x}\;\Varid{y})\oplus(\FN{\Omega}\;\Varid{u}\;\Varid{v})\mathrel{=}\FN{\Omega}\;(\Varid{x}\VarSym{+}\Varid{u})\;(\Varid{y}\VarSym{+}\Varid{v}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Finally, \ensuremath{\FN{\omega}} may be computed for trees.
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\FN{\omega}\ConSym{::}\mathsf{Ord}\;\VarSym{\alpha}\Rightarrow \mathsf{Tree}\;\VarSym{\alpha}\to \FN{\Omega}{}\<[E]%
\\
\>[3]{}\FN{\omega}\mathrel{=}\llbracket\;\FN{\Omega}\;\FN{edgeViolations}\;\FN{length}\;\rrbracket\circ\FN{allEdges}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
We compute the cumulative \ensuremath{\FN{\omega}} of the trees contained in a document as follows:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\FN{analyzeDocument}\ConSym{::}\mathsf{Document}\to \FN{\Omega}{}\<[E]%
\\
\>[3]{}\FN{analyzeDocument}\;\Varid{doc}\mathrel{=}\FN{mconcat}\;\llbracket\;\FN{\omega}\;(\FN{treesFromDocument}\;\Varid{doc})\;\rrbracket{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
We will wish to compare the \ensuremath{\FN{\omega}} for parts of the \emph{Antigone}. A section
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mathkw{let}\;\Varid{totalOmega}\mathrel{=}\FN{compute_\omega}\mathbin{\$}\FN{mconcat}\;\Varid{omegas}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mathkw{let}\;\Varid{body}\mathrel{=}\FN{fold}\mathbin{\$}\FN{uncurry}\;\Varid{makeTableRow}\;\mathop{\langle\$\rangle}\;\Varid{zip}\;\Varid{sections}\;(\FN{compute_\omega}\;\mathop{\langle\$\rangle}\;\Varid{omegas}){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mathkw{let}\;\Varid{avg}\mathrel{=}\Char{\char34 \char92 \char92 midrule\char92 \char92 multicolumn\char123 3\char125 \char123 r\char125 \char123 |cumulative~omega|~=~|\char34}\plus \Varid{showRational}\;\Varid{totalOmega}\plus \Char{\char34 |\char125 \char92 \char92 \char92 \char92 \char34}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%

...
\\
\>[3]{}\FN{rootVertex}\;\Varid{es}\mathrel{=}\FN{find}\;(\notin \FN{deps})\;\FN{heads}Integer\;\mathkw{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\FN{heads}Integer{}\<[12]%
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\FN{onEdge}\ConSym{::}\mathsf{Eq}\;\alpha\Rightarrow \alpha\to \mathsf{Edge}\;\alpha\to \mathsf{Bool}{}\<[E]%
\\
\>[3]{}\FN{onEdge}\;\Varid{i}\;(\Varid{x}\leftrightarrow\Varid{y})\mathrel{=}\Varid{x}\equiv \Varid{i}\mathrel{\vee}\Varid{y}\equiv \Varid{i}{}\<[E]%
\\[\blanklineskip]%
\>[3]{}\FN{oppositeVertex}\ConSym{::}\mathsf{Eq}\;\alpha\Rightarrow \alpha\to \mathsf{Edge}\;\alpha\to \alpha{}\<[E]%
\\
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\FN{depth}\ConSym{::}\mathsf{Tree}\;\alpha\to \mathbb{Z}{}\<[E]%
\\
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\FN{edgeWithRange}\ConSym{::}(\mathsf{Ord}\;\alpha)\Rightarrow [\mskip1.5mu \alpha\mskip1.5mu]\to \mathsf{Edge}\;\alpha{}\<[E]%
\\
...
\\
\>[3]{}\Varid{z}\in_R\Varid{x}\leftrightarrow\Varid{y}{}\<[24]%
\>[24]{}\mathrel{=}{}\<[24E]%
\>[28]{}\Varid{z}\VarSym{>}\FN{minimum}\;{}\<[42]%
\>[42]{}[\mskip1.5mu \Varid{x},\Varid{y}\mskip1.5mu]{}\<[E]%
\\
\>[24]{}\mathrel{\wedge}{}\<[24E]%
\>[28]{}\Varid{z}\VarSym{<}\FN{maximum}\;{}\<[41]%
\>[41]{}[\mskip1.5mu \Varid{x},\Varid{y}\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\FN{totalArcs}{}\<[17]%
\>[17]{}\mathrel{=}\FN{length}\;\FN{edges}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\FN{violations}{}\<[17]%
\>[17]{}\mathrel{=}\FN{fromIntegral}\;(\FN{edgeViolations}\;\FN{edges}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\end{document}

...
\\
\>[3]{}\FN{rootVertex}\;\Varid{es}\mathrel{=}\FN{find}\;(\notin \Varid{deps})\;\Varid{heads}\;\mathkw{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{heads}{}\<[12]%
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\FN{buildWithRoot}\;\Varid{es}\;\Varid{root}\mathrel{=}\Varid{root}\curvearrowright\Varid{sortedChildren}\;\mathkw{where}{}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\Varid{roots}{}\<[23]%
...
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\Varid{children}{}\<[23]%
\>[23]{}\mathrel{=}\FN{buildWithRoot}\;(\FN{filter}\;(\neg \circ\FN{onEdge}\;\Varid{root})\;\Varid{es})\;\mathop{\langle\$\rangle}\;\Varid{roots}{}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\Varid{sortedChildren}{}\<[23]%
\>[23]{}\mathrel{=}\FN{sortBy}\;(\FN{compare}\mathbin{`\FN{on}`}\FN{getLabel})\;\Varid{children}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[3]{}\FN{levels}\;\Varid{t}\mathrel{=}\Varid{map}\;(\Varid{map}\;\FN{getLabel})\mathbin{\$}{}\<[E]%
\\
\>[3]{}\hsindent{12}{}\<[15]%
...
\>[25]{}\mathrel{=}\FN{sum}\mathbin{\$}(\FN{checkEdges}\;\Varid{x}\;\mathop{\langle\$\rangle}\;\FN{rangesBelow}\;\Varid{x}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks

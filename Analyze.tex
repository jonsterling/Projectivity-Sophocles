...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\FN{\omega}\ConSym{::}(\mathsf{Fractional}\;\Varid{n},\mathsf{Ord}\;\VarSym{\alpha})\Rightarrow \mathsf{Tree}\;\VarSym{\alpha}\to \Varid{n}{}\<[E]%
\\
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\FN{edgeFromWord}\ConSym{::}\mathsf{Read}\;\VarSym{\alpha}\Rightarrow \mathsf{Word}\to \mathsf{Maybe}\;(\mathsf{Edge}\;\VarSym{\alpha}){}\<[E]%
\\
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\FN{treeFromSentence}\ConSym{::}(\mathsf{Ord}\;\VarSym{\alpha},\mathsf{Read}\;\VarSym{\alpha})\Rightarrow \mathsf{Sentence}\to \mathsf{Maybe}\;(\mathsf{Tree}\;\VarSym{\alpha}){}\<[E]%
\\
\>[3]{}\FN{treeFromSentence}\mathrel{=}\FN{treeFromEdges}\circ\FN{edgesFromSentence}\;\mathkw{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\FN{edgesFromSentence}\ConSym{::}\mathsf{Read}\;\VarSym{\alpha}\Rightarrow \mathsf{Sentence}\to [\mskip1.5mu \mathsf{Edge}\;\VarSym{\alpha}\mskip1.5mu]{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\FN{treesFromXML}\ConSym{::}(\mathsf{Integral}\;\VarSym{\alpha},\mathsf{Read}\;\VarSym{\alpha})\Rightarrow \mathsf{XML}\to [\mskip1.5mu \mathsf{Tree}\;\VarSym{\alpha}\mskip1.5mu]{}\<[E]%
\\
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\FN{treesFromFile}\ConSym{::}(\mathsf{Read}\;\VarSym{\alpha},\mathsf{Integral}\;\VarSym{\alpha})\Rightarrow \mathsf{FilePath}\to \mathsf{IO}\;[\mskip1.5mu \mathsf{Tree}\;\VarSym{\alpha}\mskip1.5mu]{}\<[E]%
\\

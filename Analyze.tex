...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\mathkw{data}\;\FN{\Omega}\mathrel{=}\FN{\Omega}\;\{\mskip1.5mu \FN{violationCount}\ConSym{::}\mathbb{Z},\FN{edgeCount}\ConSym{::}\mathbb{Z}\mskip1.5mu\}{}\<[E]%
\\
\>[3]{}\FN{compute_\omega}\ConSym{::}\FN{\Omega}\to \mathbb{Q}{}\<[E]%
\\
\>[3]{}\FN{compute_\omega}\mathrel{=}\left\llbracket\;\dfrac{\FN{violationCount}}{\FN{edgeCount}}\right\rrbracket{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\ignore{
\begin{hscode}\SaveRestoreHook

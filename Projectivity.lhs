...
by developing a quantitative metric |proj| for projectivity and comparing it
across lyrics, trimeters and anapaests using the data provided by the Perseus
Ancient Greek Dependency Treebank \citep{perseustreebanks2011}. In the
appendices, the formal algorithm for the computations done herein is developed
in the programming language Haskell \citep{haskell2010}.}

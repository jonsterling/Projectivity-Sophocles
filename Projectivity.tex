...
by developing a quantitative metric \ensuremath{\FN{\wp}} for projectivity and comparing it
...
their computed \ensuremath{\FN{\wp}} values, and a cumulative \ensuremath{\FN{\wp}} value for the entire set.
